...
```bash
[git clone URL_DO_REPOSITORIO](https://github.com/devrafael16/fastfood-management-system.git)
```
...
![Menu](screenshots/img1.png)
![Resumo](screenshots/img2.png)
![Ver_pedido](screenshots/img3.png)
![Excluir](screenshots/img4.png)
